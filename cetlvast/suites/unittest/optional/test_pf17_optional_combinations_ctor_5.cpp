...
template <typename>
class test_optional_combinations_ctor_5 : public ::testing::Test
{};

TYPED_TEST_SUITE(test_optional_combinations_ctor_5, testing_types, );

using cetl::pf17::optional;

/// ------------------------------------------------------------------------------------------------

TYPED_TEST(test_optional_combinations_ctor_5, ctor)
{
