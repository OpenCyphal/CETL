...
def _run(args: argparse.Namespace) -> int:
    ...
    for glob_result in glob_results:
        ...
        run_args = [args.clang_format_path, '-fallback-style=none', '-style=file']
        if args.inplace:
            run_args += ['-i', glob_result]
        else:
            run_args += ['-output-replacements-xml', glob_result]
        ...
        if not args.inplace:
            ...
            try:
                ...
                for replacements_element in replacement_dom.childNodes:
                    if replacements_element.nodeName == 'replacements':
                        for replacement_element in replacements_element.childNodes:
...
'''
    ...
    parser.add_argument('-i', '--inplace', action='store_true',
                        help='inplace edit the files if needed.')
